...
t1_mat1 <- gheatmap(t1_tips, meta_matrix.site, width=0.1, 
                    colnames_offset_y=8, legend_title="Sample Site", colnames_position='top', font.size=3) +
  scale_fill_viridis_d(option="B", name="Sample Site") +
  new_scale_fill()

gheatmap(t1_mat1, meta_matrix.host, width=0.1, offset=0.0125,
         colnames_offset_y=2.5, legend_title="Host", colnames_position='top', font.size = 3) +
